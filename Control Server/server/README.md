...
## Pip Dependencies
*Make sure to run `python -m pip install --upgrade pip` to ensure you have the latest version of pip. Alternitavely use the quickstart files in the dependency folder. There are install scripts for all dependencies inside these scripts for Windows Powershell and macOS Terminal.*
